...
WC_CONNECT_CALLBACK g_connect_cb = NULL;
WC_LOSTCONNECT_CALLBACK g_lostconnect_cb = NULL;
WC_DISCONNECT_CALLBACK g_disconnect_cb = NULL;
WC_MESSAGE_CALLBACK g_message_cb = NULL;
